...
export const CompressIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 3v7.5" /><path d="m15 7.5-3 3-3-3" /><path d="M3 12h7.5" /><path d="m7.5 9-3 3 3 3" /><path d="M12 21v-7.5" /><path d="m9 16.5 3-3 3 3" /><path d="M21 12h-7.5" /><path d="m16.5 15 3-3-3-3" />
  </svg>
);
...
export const ImageToPdfIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect width="18" height="18" x="3" y="3" rx="2" ry="2" />
    <circle cx="9" cy="9" r="2" />
    <path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" />
    <path d="M14 2H6a2 2 0 0 0-2 2v2" />
    <path d="M20 2h-2a2 2 0 0 0-2 2v2" />
    <path d="M14 22h-2a2 2 0 0 1-2-2v-2" />
...
export const WandIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M5.5 7L4 8.5" />
    <path d="m21 14-5 5" />
    <path d="M12.5 21.5 3.5 12.5 12.5 3.5 21.5 12.5Z" />
  </svg>
);
...
export const SplitIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M19 13h-4a2 2 0 0 0-2 2v4" />
    <path d="M15 13a2 2 0 0 1 2-2h4" />
    <path d="M5 19h14" />
    <path d="M5 5h14" />
    <path d="M19 5v4a2 2 0 0 1-2 2H7a2 2 0 0 0-2 2v4" />
  </svg>
);